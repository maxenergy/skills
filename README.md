...
- **[goal-dispatch](./skills/engineering/goal-dispatch/SKILL.md)** -- Dispatch a compiled /goal to any AgentOS coding agent (codex_cli, anthropic, gemini, qwen), with per-task verification, retry-with-error-context, and adversarial Stop Rule review.
